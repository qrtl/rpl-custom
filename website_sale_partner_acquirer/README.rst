...
.. |badge3| image:: https://img.shields.io/badge/github-qrtl%2Frpl--custom-lightgray.png?logo=github
    :target: https://github.com/qrtl/rpl-custom/tree/12.0/website_sale_partner_acquirer
    :alt: qrtl/rpl-custom
...
`feedback <https://github.com/qrtl/rpl-custom/issues/new?body=module:%20website_sale_partner_acquirer%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `qrtl/rpl-custom <https://github.com/qrtl/rpl-custom/tree/12.0/website_sale_partner_acquirer>`_ project on GitHub.

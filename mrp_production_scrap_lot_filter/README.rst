===============================
MRP Production Scrap Lot Filter
===============================
...
.. |badge3| image:: https://img.shields.io/badge/github-qrtl%2Frpl--custom-lightgray.png?logo=github
    :target: https://github.com/qrtl/rpl-custom/tree/12.0/mrp_production_scrap_lot_filter
    :alt: qrtl/rpl-custom
...
`feedback <https://github.com/qrtl/rpl-custom/issues/new?body=module:%20mrp_production_scrap_lot_filter%0Aversion:%2012.0%0A%0A**Steps%20to%20reproduce**%0A-%20...%0A%0A**Current%20behavior**%0A%0A**Expected%20behavior**>`_.
...
This module is part of the `qrtl/rpl-custom <https://github.com/qrtl/rpl-custom/tree/12.0/mrp_production_scrap_lot_filter>`_ project on GitHub.

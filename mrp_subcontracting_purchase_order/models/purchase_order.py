...
class PurchaseOrder(models.Model):
    ...
    subcontract_production_ids = fields.One2many('mrp.production', "purchase_order_id", "Subcontract Production Orders", readonly=True)
    subcontract_production_count = fields.Integer(compute='_compute_subcontract_production_count')

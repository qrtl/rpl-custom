...
class TestStockLotExpiryRpl(common.TransactionCase):
    ...
    def test_00_stock_lot_expiry(self):
        ...
        date = self.env['stock.production.lot'].with_context(
            {'tz': 'Japan'})._calculate_expiry_date(
            self.productAAA.id, date_utc)

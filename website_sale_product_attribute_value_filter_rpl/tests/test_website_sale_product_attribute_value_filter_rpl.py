...
class TestWebsiteSaleProductAttributeValueFilterRpl(common.TransactionCase):
    ...
    def test_00_no_constriants(self):
        ...
        self.assertEqual(self.test_product_template.with_context(
            self.demo_context)._is_combination_possible(self.product_template_steel_attribute_value), True)
    ...
    def test_03_partner_with_country_outside_attribute_country_group(self):
        ...
        self.assertEqual(self.test_product_template.with_context(
            self.demo_context)._is_combination_possible(self.product_template_steel_attribute_value), False)
    ...
    def test_05_public_user(self):
        ...
        self.assertTrue(self.test_product_template.sudo(
            self.public_user.id).with_context(self.public_context).\
                _is_combination_possible(
                    self.product_template_steel_attribute_value))
